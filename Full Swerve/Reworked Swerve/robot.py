...
'''The following comment should be outdated because it is now 2020
...
class MyRobot(wpilib.TimedRobot):
	def robotInit(self):
		...
		#Drive motors
		self.flDriveMotor = rev.CANSparkMax(3, rev.MotorType.kBrushless)
		self.frDriveMotor = rev.CANSparkMax(7, rev.MotorType.kBrushless)
		self.rlDriveMotor = rev.CANSparkMax(1, rev.MotorType.kBrushless)
		...
		#Turn motors
		self.flTurnMotor = rev.CANSparkMax(4, rev.MotorType.kBrushless)
		self.frTurnMotor = rev.CANSparkMax(8, rev.MotorType.kBrushless)
		self.rlTurnMotor = rev.CANSparkMax(2, rev.MotorType.kBrushless)
	...
	def swerveMath(self, x, y, z):
		...
		#rear right is 2
		#rear left is 3
		self.motors.append([self.flTurnEncoder,flSpeed,flAngle])
		self.motors.append([self.frTurnEncoder,frSpeed,frAngle])
		self.motors.append([self.rlTurnEncoder,rlSpeed,rlAngle])
		self.motors.append([self.rrTurnEncoder,rrSpeed,rrAngle])
